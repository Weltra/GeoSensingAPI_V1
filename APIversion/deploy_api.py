...
from DeployTool.hybrid_sensor_from_scratch import HybridSensorFromScratchOptimizer
from DeployTool.hybrid_sensor_position_optimize import HybridSensorPositionOptimizer
from DeployTool.hybrid_sensor_addition_optimize import HybridSensorAdditionOptimizer
from DeployTool.geojson_ground_sensor_from_scratch import GeoJSONGroundSensorFromScratchSolver
from DeployTool.geojson_ground_sensor_position_optimize import GeoJSONGroundSensorPositionOptimizer

# 修复导入错误 - 只导入实际存在的类
from DeployTool.advanced_sensor_optimization import (
    SensorNetworkOptimizer, 
    GeneticAlgorithmOptimizer, 
    SimulatedAnnealingOptimizer,
    ResourceBalanceOptimizer,
    Satellite,
    GroundSensor,
    ResourceConstraints
)
